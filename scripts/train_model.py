...
if __name__ == "__main__":
    ...
    print(f"  - {os.path.join(OUTPUT_DIR, 'scalter_weights.pt')}         (Model weights)")
    print(f"  - {os.path.join(OUTPUT_DIR, 'scalter_checkpoint.pt')} (Model weights + config)")
    print(f"  - {os.path.join(OUTPUT_DIR, 'run_config.json')}             (Run configuration)")
    print(f"  - {os.path.join(OUTPUT_DIR, 'training_history.json')}       (Training log)")
